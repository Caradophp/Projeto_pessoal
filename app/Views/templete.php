...
<html lang="pt-br">
   <head>
      ...
      <title>{{title}}</title>
      <link rel="stylesheet" href="http://localhost/deucerto/phpup/Model_View_Controller/public/css/style.css">
         ...
         <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
            <div class="container-fluid">
               ...
               <div class="collapse navbar-collapse" id="collapsibleNavbar">
                  ...
                  &nbsp&nbsp&nbsp&nbsp&nbsp
                  &nbsp&nbsp&nbsp&nbsp
                  <button class="btn btn-warning"><a href="http://localhost/deucerto/phpup/Model_View_Controller/login" style="text-decoration: none; color:black;">LOGIN</a></button>
               </div>
            </div>
         </nav>
      </header>
